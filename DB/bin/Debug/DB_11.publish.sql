/*
Script de déploiement pour Essai-DB-ExoMaison
...
GO
:setvar DatabaseName "Essai-DB-ExoMaison"
:setvar DefaultFilePrefix "Essai-DB-ExoMaison"
...
GO
PRINT N'Création de Contrainte de validation [dbo].[CK_Person_Birth_Date]...';


GO
ALTER TABLE [dbo].[Person]
    ADD CONSTRAINT [CK_Person_Birth_Date] CHECK (DATEDIFF(YEAR, [Birth_Date], GETDATE()) >= 18 
...
END
GO
PRINT N'Création de Procédure [dbo].[sp_CheckPassword]...';
...
END
GO
PRINT N'Création de Procédure [dbo].[SP_CreateUser]...';
...
END;
GO
PRINT N'Création de Procédure [dbo].[sp_DeleteUser]...';
...
END;
GO
PRINT N'Création de Procédure [dbo].[sp_GetUserById]...';
...
END
GO
PRINT N'Création de Procédure [dbo].[sp_UpdateUser]...';
